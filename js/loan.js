...
if (n<100)
{
 ...
 {
     ss= " And "+f2( Math.trunc(n/1000)) + " thousand " + convert(n%1000);
 }
 else if(n>=100000 && n<10000000)
 {
     ss=" And " +f2( Math.trunc(n/100000)) + " lakh " + convert(n%100000);
 }
 else if(n>=10000000 && n<1000000000)
 {
     ss=" And "+f2( Math.trunc(n/10000000)) + " crore " + convert(n%10000000);
